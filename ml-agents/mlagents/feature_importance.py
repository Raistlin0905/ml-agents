...
selector = FeatureImportance(
    csv_path="C:\Users\ebput\OneDrive\Documents\Projects\2-1Project\ml-agents\outputpath.csv", model=XGBRegressor(), target="total_duration"
)
...
selector.save_cleaned_dataset(clean_df, "cleaned_pool.csv")
